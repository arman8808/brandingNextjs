  ...
  const imagesData = [
    {
      ...
      text: "Crafting a dynamic marketing strategy and a bespoke online hub tailored to your business, we attract fresh prospects and enhance your credibility.",
    },
    {
      image: CreativeWorksCollageImg2,
      heading: "Branding",
      text: "At Branding 360 Neo Pvt. LTD, our team of creative minds and strategic thinkers in brand marketing is devoted to shaping memorable brands that leave a lasting impression.",
    },
    {
      image: CreativeWorksCollageImg3,
      heading: "Creative Designing",
      text: "Our proficiency lies in seamlessly integrating creative designs with data to address intricate communication challenges, positioning us as an innovative branding agency in India.",
    },
    {
      image: CreativeWorksCollageImg4,
      heading: "Social Media Management",
      text: "In a realm of routine posting, we bring a specialized touch to strategic social media marketing strategy. Tailored strategies and flawless execution are our expertise!",
    },
    {
      image: CreativeWorksCollageImg5,
      heading: "Search Engine Optimization",
      text: "As a leading SEO Company in India, Branding 360 Neo Pvt. LTD provide ethical, results-driven SEO services. Leveraging cutting-edge tools and strategic trends, we elevate your visibility on search engines for targeted keywords.",
    },
    {
      image: CreativeWorksCollageImg6,
      heading: "Performance Marketing",
      text: "More than your typical performance marketing agency, Branding 360 Neo Pvt. LTD embodies a brand focused on growth. Our team of seasoned experts is committed to maximizing conversion rates.",
    },
  ];
      ...
      <div className="creative-works-top">
        <div>
          ...
          <span className="app-yellow-text" style={{ color: "#3d3d3d" }}>
            Discover an array of case studies highlighting the instrumental role
            our customer-centric marketing agency played in aiding clients to
      ...
      <div className="creative-works-main">
        <div className="creative-works-main-left">
          <Image
            width={0}
            height={0}
            src={HomeCreativeWorksMainLeftImg}
            alt="Creative Works"
          />
