...
const page = () => {
  const infoContainerData = {
    ...
    mainHeading:
      "Relevance and creativity are the cornerstones of successful marketing campaigns, and achieving them is possible through the leading graphic design company in India. Within our branding and design agency, a skilled team of graphic and creative designers excels in breathing life into your brand with innovative and imaginative illustrations.",
    text: [
      "Whether your needs include imaginative designs for social media campaigns, logo design in India, banner ads, creative content for email campaigns, or brochure design services in the UAE, our graphic design services offer prompt delivery and competitive pricing. As a UI/UX Design Services Company, we also specialize in providing innovative and creative designs and layouts for your upcoming business websites.",
      "Distinguished from other branding and logo design companies, we invest time in thoroughly understanding your creative brief, projected mediums and channels, brand design guidelines, target audience, and then strategically plan the process for logo design in India.",
      "In our creative branding and design pursuits, we transcend the conventional promotion of products, services, or brands. Instead, we craft narratives that forge a profound connection with your target audience. Through a seamless integration of design visuals and compelling copy, our final designs stand out as distinctive and impactful, resonating both verbally and visually.",
    ],
  };

  const cardsContainerData = {
    bgHeading: "Design",
    mainHeading: "Explore our Creative Design Services",
    cardsData: [
      {
        icon: (
          <svg
        ...
        heading: "Banner & Poster Design",
        text: "Our services focus on creating tailor-made designs that reflect the essence of the brand and its message, tailored to suit the specific target audience and goals.",
      },
      {
        icon: (
          <svg
        ...
        heading: "Logo Design in India",
        text: "Step away from ordinary templates and embrace a distinctive perspective! Make a lasting impact with our brand logo design services, where we craft logos that immediately seize attention.",
      },
      {
        icon: (
          <svg
        ...
        text: "Elevate your content using our professional video editing and post-production services that exude sophistication. Our specialization lies in diverse levels of video editing, with a specific emphasis on incorporating creative elements to add a touch of uniqueness and flair.",
      },
      {
        icon: (
          <svg
        ...
        text: "Our designers excel in crafting personalized branding and marketing reels that encapsulate the core essence of the brand, specifically tailored to the distinct target audience. Our expertise lies in producing engaging and vibrant short-form videos that cater to the needs of both individuals and businesses alike.",
      },
      {
        icon: (
          <svg
        ...
        heading: "Reel Creations",
        text: "In search of infographics, editorial illustrations, character sketches, product drawings, or any other design services? Alongside our logo design services in India, we specialize in delivering personalized design solutions that blend seamlessly with the identity of your brand.",
      },
      {
        icon: (
          <svg
        ...
        heading: "User Interface/User Experience (UI/UX) Design",
        text: "If your goal is to propel your product development forward with experts committed to a systematic design approach, meeting strict deadlines, and seamlessly delivering accurate outcomes, look no further than Branding 360 Neo LLC. As a company specializing in UI/UX Design Services, we guarantee an effective design process that yields robust results efficiently and within a tight timeframe.",
      },
    ],
  };
  ...
  const midContentData = {
    heading:
      "Are you seeking to make a lasting first impression with cutting-edge design services in India?",
    text: [
      "Shaping an ideal fusion of shapes, colors, and words is pivotal in defining your brand. Choose Branding 360 Neo Pvt. LTD for impeccable graphic and logo design services, ensuring your brand stand out with distinction.",
    ],
    mainImg: ServicesMidMainImg,
    rightImg: ServicesMidRightImg,
    type: "paras",
    leftContent: [
      "Our dynamic team of designers doesn't limit itself to crafting business cards, visiting cards, or logos in India; we specialize in providing comprehensive branding and marketing solutions as well.",
    ],
  };

  const faqData = [
    {
      ques: "How Can a Creative Design Agency in India Contribute to Your Goals?",
      ans: [
        "At Branding 360 Neo, we adopt a comprehensive approach to drive growth by seamlessly integrating various online marketing strategies, techniques, and tactics into our graphic design services to maximize effectiveness.",
      ],
    },
    {
      ques: "Are You Looking to Establish a Lasting Brand?",
      ans: [
        "Internally, we've developed a modern approach to creative design marketing that aims to empower your company's success through a meticulously executed growth strategy.",
    ...
    {
      ques: "What Can You Anticipate from a Leading Creative Design Agency in India?",
      ans: [
        "With the support of our creative design marketing agency, your content will not only generate qualified leads but also secure more deals. Our precision-targeted graphic marketing campaigns effectively engage your desired audience. Implementing creative design marketing strategies while mapping your customer journey ensures that your company's growth is sustainable! repeatable, and scalable.",
    ...
    {
      ques: "Why Engage a Leading Creative Design Agency in India?",
      ans: [
        "Businesses often face the decision between in-house visual development marketing and partnering with a trusted agency. Branding 360 Neo's modern approach relies on data-driven decisions to hyper-target prospects. Here are the key benefits for entrepreneurs and businesses working with us:",
        "  - Utilize advanced creative design strategies to attract specific visitors.",
        "  - Achieve growth goals through expertise in creative design, social media, SEO, and more.",
        ...
        "  - Allow our visual marketing services to position you as a leader in your industry.",
        "  - Partner with a results-driven and data-oriented agency with a proven track record.",
      ],
    },
    {
      ques: "Who Can Utilize Our Creative Design Services?",
      ans: [
  ...
  return (
    <div className="services-main-section app-sections">
      <BannerMain
        bgImage={
          "/Assets/Services-Creative-Design/CreativeDesignBanerBgImg.webp"
        }
        currentPage="Graphic Designing Services"
      />
