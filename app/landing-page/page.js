          ...
          <Marquee className="marquee-main" direction="down">
            ...
            <div className="marquee">
              <Image
                width={0}
                height={0}
                src={LandingPageBannerLeftImg1}
                alt="Landing Page"
              />
              <Image
                width={0}
                height={0}
                src={LandingPageBannerLeftImg2}
                alt="Landing Page"
              />
              <Image
                width={0}
                height={0}
                src={LandingPageBannerLeftImg3}
                alt="Landing Page"
              />
            </div>
            <div className="marquee-right">
              <Image
                width={0}
                height={0}
                src={LandingPageBannerRightImg1}
                alt="Landing Page"
              />
              <Image
                width={0}
                height={0}
                src={LandingPageBannerRightImg2}
                alt="Landing Page"
              />
              <Image
                width={0}
                height={0}
                src={LandingPageBannerRightImg3}
                alt="Landing Page"
              />
            </div>
          </div>
      ...
      <div className="landing-what-we-do-section">
        ...
        <div className="landing-what-we-do-section-right">
          <Image
            width={0}
            height={0}
            src={LandingWhatWeDoRightImg}
            alt="What WE Do"
          />
          <h3 className="app-yellow-text">Services Offered</h3>
        </div>
      </div>
      <div className="landing-page-need-help-section" ref={needHelpRef}>
        <NeedHelpMain />
      </div>
