  ...
  return (
    <div className="about-us">
      <BannerMain
        ...
        bgImage={"/Assets/AboutUs/AboutUsBannerBgImg.jpeg"}
      />
      <InfoContainer
        image={HomeInfoContImg}
        subheading="// DISCOVER OUR COMPANY"
        heading="Discover unparalleled Customer-Centric Branding and Marketing Excellence in India with Branding 360 Neo Pvt. Ltd!"
        text="Branding 360 Neo Pvt. LTD stands as a distinguished leader in the realm of brand and marketing agency in India. Whether it involves devising marketing strategies, harnessing the power of social media, excelling in performance marketing, managing branding initiatives, engaging in web design and development, traditional advertising, or delving into the realms of content marketing and more, we excel in every aspect, offering tailor-made solutions to meet specific business objectives."
        text2="Functioning as a premier branding agency in India, our primary focus lies in establishing a strong connection between customers and brands through innovative brand experiences. In the ever-evolving business landscape, we understand the necessity of adopting novel approaches to marketing strategy. Crafting campaigns and strategies that truly resonate with customers demands a swift, data-driven, and impactful approach, grounded in a profound understanding of customer preferences. Marketing companies in India leveraging this insightful knowledge to create compelling products are well-positioned for success with their customers."
        cardText={[
          "As one of the leading branding and marketing companies in India, we are committed to developing result-oriented strategies and campaigns that define a brand's distinctive experience and qualities.",
          "Acknowledged as one of the top marketing companies in India, we stress the importance of collaboration and iteration, ensuring consistent support throughout the entire branding and marketing journey.",
          "Whether it's performance marketing, web development, or establishing a social media presence, our marketing agency prioritizes the creation of impactful and targeted interactions.",
        ]}
        readMore="false"
      />
      <div className="home-sbout-us-heading about-us-our-story">
        <h2>
          Our Identity
          <span>Premier Marketing & Branding Agency in India!</span>
        </h2>
      ...
      <div className="about-us-who-are-we">
        <div>
          ...
          <div className="about-us-who-are-we-right">
            <h3>
              We are a dynamic Branding and Marketing Agency in India, Elevating
              Brands through Culture, Vision, and Purpose!
            </h3>
            <div className="who-are-we-paras">
              <p>
                Branding 360 Neo Pvt. LTD stands out prominently as a marketing
                and branding agency in India, offering bespoke solutions and
                services centered around customer satisfaction and revenue
                generation.
              </p>
              <p>
                In 2017, a group of seasoned marketing professionals with
                extensive industry experience joined forces to establish a
                branding and marketing agency in the bustling city of India,
                Lucknow. With expanded operations in India (housing our
                technical department) and Dubai (managing Sales and Accounts),
                we have swiftly emerged as one of the rapidly flourishing,
                all-encompassing marketing and branding companies in India.
              </p>
              <p>
                Since our inception, our commitment has remained steadfast in
                delivering personalized and unique marketing and branding
                services and solutions to our clients. With a growing clientele,
                we are deeply embedded in the vibrant city of Lucknow, staying
                attuned to the latest digital trends and solutions while eagerly
                embracing new challenges.
              </p>
              <p>
                Our dedication to excellence has propelled our branding agency
                in India to the forefront, enabling us to establish a
                significant global presence in the industry. Acknowledged for
                our adept application of knowledge, our goal is to seamlessly
                align our clients with their consumers.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="about-us-how-we-do-it-right">
          ...
          <div className="about-us-how-we-do-it-small-headings headings-center">
            ...
            <div className="about-us-how-we-do-it-headings-right">
              <h3 className="app-yellow-text">Initial Sales Call</h3>
              <span>
                Engaging in sales calls is a pivotal step for us to delve deeper
                into our audience's needs, enabling us to foresee the most
                impactful marketing strategy tailored to specific business goals
                and requirements.
              </span>
            </div>
          </div>
          <div className="about-us-how-we-do-it-small-headings headings-right">
            ...
            <div className="about-us-how-we-do-it-headings-right">
              <h3 className="app-yellow-text">Technical Consultation</h3>
              <span>
                As one of the best marketing agencies in India, we consistently
                arrange technical meetings. These sessions serve as a platform
                for the brand and agency to align interpretations, address any
                lingering issues, and promote unity, fostering a cohesive team
                progression.
              </span>
            </div>
          </div>
          <div className="about-us-how-we-do-it-small-headings headings-center">
            ...
            <div className="about-us-how-we-do-it-headings-right">
              <h3 className="app-yellow-text">Team Collaboration</h3>
              <span>
                The conduct of team meetings proves to be an effective approach
                in aiding our team to comprehend the client's objectives, goals,
                and responsibilities, ensuring a synchronized effort.
              </span>
            </div>
          </div>
          <div className="about-us-how-we-do-it-small-headings headings-left">
            ...
            <div className="about-us-how-we-do-it-headings-right">
              <h3 className="app-yellow-text">Onboarding Conversation</h3>
              <span>
                The customer onboarding process holds paramount importance for a
                marketing agency in Lucknow, fostering mutual understanding and
                establishing clear expectations for the ongoing relationship.
              </span>
            </div>
          </div>
      ...
      <div className="about-us-founders-section">
        <div className="about-us-founder-container">
          <div className="about-us-founder-left">
            ...
            <p>
              Rishabh Agrawal, holding the position of Director & Operations at
              Branding 360 Neo Pvt. LTD, ventured into the dynamic realm of
              Marketing driven by his passion for mathematics, analytics, and
              human psychology. In 2017, he embarked on an entrepreneurial
              journey, establishing Branding 360 Neo Pvt. LTD, and gained
              expertise in SEO, Inbound Marketing, and Advertising through the
              development and promotion of his business website.
            </p>
            <p>
              His relentless pursuit of knowledge prompted him to explore
              various digital marketing techniques during his academic years.
              Believing in continuous learning, he honed his skills in SEO, SMO,
              content strategy, graphic design, online business growth, sales
              conversion, website design, e-commerce solutions, and online
              advertising.
            </p>
            <p>
              As an ardent enthusiast, he takes satisfaction in guiding others
              into the realm of Digital Marketing, assisting them in initiating
              their professional journeys. His dedication to ongoing learning
              and supporting others has not only defined his identity as a
              marketer but also as an individual committed to constant
              improvement.
            </p>
            <div>
              <svg
        ...
        <div className="about-us-founder-container about-founder-reverse">
          <div className="about-us-founder-left">
            ...
            <p>
              ...
              Neo Pvt. LTD in 2020, infusing the team with expertise,
              innovation, and a results-oriented approach. Proficient in
              formulating impactful digital marketing and sales strategies, he
              supervises digital engagement, business development, and sales
              management. Devoted to steering strategic relationships towards
              business goals, he is committed to propelling organizations to new
              heights.
            </p>
            <p>
              As the marketing and financial leader at Branding 360 Neo Pvt.
              LTD, Sameer draws upon his wealth of experience within the
              company. A graduate in geology from A.M.U, Aligarh, and a
              post-graduate with an M.Tech in Applied Geology, Sameer's journey
              includes pivotal roles at IIT Kanpur, where he coordinated
              projects involving GPS landholding segregation. His technical
              expertise and client-centric approach ensure a profound
              understanding of business needs, guaranteeing the success and
              growth of your ventures under his guidance at Branding 360 Neo
              Pvt. LTD.
            </p>
            <div>
              <svg
      ...
      <div className="about-us-our-core-values">
        <div className="about-core-values-left">
          <div className="about-core-values-heading-section">
            ...
            <span>
              Branding 360 Neo Pvt. LTD exemplifies its core principles through
              its team's unyielding commitment and exceptional performance.
            </span>
          </div>
